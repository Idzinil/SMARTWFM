...
<div class="datosForm">
						<table style="width: 80%" id="test" border="0" class="letrath" align="center">
							<thead>
								<tr>
									<td class="letrath">N&uacute;mero Cliente</th>
									<td class="letrath">Alias Cliente</th>
									<td class="letrath">Nombre Cliente</th>
									<td class="letrath">N&uacute;mero Factura</th>
									<td class="letrath">Monto Factura</th>
									<td class="letrath">Deuda Factura</th>
									<td class="letrath">Fecha Inicio</th>
									<td class="letrath">Fecha Fin</th>
									<td class="letrath">Moneda</th>
									<c:if test="${isRefacturacion}">
										<td class="letrath">Fecha Facturaci&oacute;n
									</c:if>
