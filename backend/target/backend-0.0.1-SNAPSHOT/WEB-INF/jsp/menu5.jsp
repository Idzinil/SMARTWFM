...
<div id="cabeceraSytecso">
	<ul id="css-nav">
		<li><a href="principal"> <spring:message  code="label.MenuInicio"/> </a></li>
		<security:authorize access="hasRole('ROLE_USER')">	
			<li><a href="${pageContext.request.contextPath}/cuentasFront"> <spring:message  code="label.MenuCuentas"/> </a></li>
			
		</security:authorize>
		<security:authorize access="hasRole('ROLE_ADMIN')">	
			<li><a href="${pageContext.request.contextPath}/cuentasFront" ><spring:message  code="label.MenuAdmSis"/> </a></li>
			<li><a href="${pageContext.request.contextPath}/cuadrillasFront" class="selected"> <spring:message  code="label.MenuProd"/> </a></li>
		</security:authorize>
		<security:authorize access="hasRole('ROLE_BILLING')">	
			...
			<li><a class="selected" href="${pageContext.request.contextPath}/pagos" > <spring:message  code="label.MenuPagos"/>   <img src ="${pageContext.request.contextPath}/img/flecha-abajo-icono-8630-16.png" ></a></li>
	...
	<div id="usuarioDivSytecso"><spring:message  code="label.Bienvenido"/>,<strong> ${pageContext.request.remoteUser}</strong><br><a href="<c:url value="/logout" />"><spring:message  code="label.Salir"/></a><br></div>
	</div>
