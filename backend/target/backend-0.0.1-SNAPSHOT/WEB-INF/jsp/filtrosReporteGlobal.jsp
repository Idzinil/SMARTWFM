	...
	<div style="text-align: right;padding:5px;margin: 0px;background:#ccc;">
		...
		<div id="tituloyBarraBusqueda">
		    <div id="tituloTablero">
		        <img src="${pageContext.request.contextPath}/img/das.png" width="16px" height="16px" style="margin-left:10px;"> <spring:message  code="label.ReportesGlobal"/>
		    </div>
		</div>
		<div id="tableroSmartBilling">
	    	<div id="ventanaSmartBilling500">	
	        	<div class="contenido">
	      	 		<div id="datos">
						<div id="datosForm">  
							<form:form  id="formRepo" action="${pageContext.request.contextPath }/buscarReporteGlobal" method="POST"   modelAttribute="reporte">
