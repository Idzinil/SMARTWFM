		...
		<div id="tableroSmartBilling">
	    	<div id="ventanaSmartBilling500">	
	        	<div class="contenido">
	      	 		<div id="datos">
						<div id="datosForm">  
							<form:form  id="formAjustes" action="${pageContext.request.contextPath }/buscarDatosAjuste" method="POST"   modelAttribute="ctsfac">
									<table  id="test" style="width: 90%; border="0" class="letra">
										<tr>
											<td class="letrath"  bgcolor="#2584A7" >
												<form:label path="factura.numeroFactura" type="text" ><b><spring:message  code="label.AdjNoFact"/></b></form:label>
												<abbr title="Campo obligatorio">
												<spring:message  code="label.AdjNoFactph" var ="labelFactura"/>
													<form:input id="numeroFactura" type="text" path="factura.numeroFactura"  placeholder="${labelFactura}" />
												</abbr>
											</td>
											<td class="letrath"  bgcolor="#2584A7" >
											...
											<td class="letrath"  bgcolor="#2584A7" >
												<form:label path="periodo" type="text" ><b><spring:message  code="label.AdjPeriod"/></b></form:label>
												<abbr title="Campo obligatorio">
												<spring:message  code="label.AdjPeriodph" var="labelPeriodo"/>
													<form:input placeholder="${labelPeriodo}"  path="periodo" class="date-picker" />
												</abbr>
											</td>
											<td class="letrath"  bgcolor="#2584A7" >
											<form:label path="ciclo" type="text" ><b><spring:message  code="label.AdjCiclo"/></b></form:label>
