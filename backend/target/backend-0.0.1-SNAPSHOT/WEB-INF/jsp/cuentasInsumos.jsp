		...
		<div id="tableroSytecso">
			...
			<br />
							 <table style="width: 80%" id="test" align="center"class="tablePrincipal" >
								...
								<c:forEach items="${ctasInsumos}" var="itemsValue">
									<tr class="letraPrincipal">
									<td>
										<b><a href="#"onClick="redir('${pageContext.request.contextPath}/cuentaInsumoForm?cuenta=${itemsValue.cuenta.numCuenta}')">
		...
		<div id="datosbotonesComp">
			<div id="botonBack">
					<div class="col-sm-6">
						...
						<a href="${pageContext.request.contextPath }/irCtasInsumos"><img src ="${pageContext.request.contextPath}/img/regresar.png"><spring:message  code="label.NavRegresar"/></a>
					</div>
				</div>
		<div id="botonHome">
				<div class="col-sm-6">
