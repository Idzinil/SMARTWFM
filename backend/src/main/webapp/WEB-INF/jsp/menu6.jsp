...
<div id="cabeceraSytecso">
	<ul id="css-nav">
		<li><a href="principal" > <spring:message  code="label.MenuInicio"/>   <img src ="${pageContext.request.contextPath}/img/flecha-abajo-icono-8630-16.png" > </a></li>
		...
		<security:authorize access="hasRole('ROLE_ADMIN')">	
			...
			<li><a href="${pageContext.request.contextPath}/productosFront"><spring:message  code="label.MenuAdmOFC"/>  <img src ="${pageContext.request.contextPath}/img/flecha-al-lado-derecho-icono-8630-16.png" ></a></li>
		</security:authorize>
...
<!-- 			<li><a href="${pageContext.request.contextPath}/verBalance"> Balance   <img src ="${pageContext.request.contextPath}/img/flecha-al-lado-derecho-icono-8630-16.png" ></a></li>	 -->
			...
			<li><a href="${pageContext.request.contextPath}/reportes" class="selected" > <spring:message  code="label.MenuRep"/>    <img src ="${pageContext.request.contextPath}/img/flecha-abajo-icono-8630-16.png" ></a></li>
		</security:authorize>
	</ul>
	<div id="iconoSmart">
