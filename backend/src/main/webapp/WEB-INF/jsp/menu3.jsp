...
<div id="usuarioDivSytecso"><spring:message  code="label.Bienvenido"/>,<strong> ${pageContext.request.remoteUser}</strong><a href="<c:url value="/logout" />">  <spring:message  code="label.Salir"/></a></div>
	<ul id="css-nav">
		<li><span class="fa fa-home"></span><a href="${pageContext.request.contextPath}/principal"> <spring:message  code="label.MenuInicio"/>    <img src ="${pageContext.request.contextPath}/img/flecha-al-lado-derecho-icono-8630-16.png" ></a></li>

		<security:authorize access="hasRole('ROLE_USER')">	
			<li><span class="fa fa-users"></span><a  href="${pageContext.request.contextPath}/cuentasFront"> <spring:message  code="label.MenuCuentas"/>   <img src ="${pageContext.request.contextPath}/img/flecha-al-lado-derecho-icono-8630-16.png" ></a></li>
			<li><span class="fas fa-file"></span> <a class="selected" href="${pageContext.request.contextPath}/tipoOrdenFront">Tipo de Ordenes<img src ="${pageContext.request.contextPath}/img/flecha-abajo-icono-8630-16.png" ></a></li>
		</security:authorize>
		<security:authorize access="hasRole('ROLE_ADMIN')">	
			...
			<li><span class="fa fa-car"></span><a href="${pageContext.request.contextPath}/cuadrillasFront" class="selected"> Admin Cuadrillas  <img src ="${pageContext.request.contextPath}/img/flecha-abajo-icono-8630-16.png" ></a></li>
		...
		<security:authorize access="hasRole('ROLE_BILLING')">	
			<li><a class="selected" href="${pageContext.request.contextPath}/facturacionFront"> <spring:message  code="label.MenuFact"/>  <img src ="${pageContext.request.contextPath}/img/flecha-abajo-icono-8630-16.png" ></a></li>
		...
		<li><a href="${pageContext.request.contextPath}/divisasFront" class="selected">   <spring:message  code="label.MenuAdmDivisas"/><img src ="${pageContext.request.contextPath}/img/flecha-abajo-icono-8630-16.png" ></a></li>
