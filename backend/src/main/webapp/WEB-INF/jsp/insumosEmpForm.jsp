...
<div id="datos">
	<form:form action="altaInsumoEmp" method="POST" commandName="comando" modelAttribute="insumo"
		id="formInsumo"  onsubmit='return validar()'>
		<p><label style="margin-left: 35%;" type="text"><b>Datos de Insumo Empresa</b></label></p>
		<table align="center" width="60%" >
    		...
    		<tr align="center">
				...
				<tr align="center">
				<td bgcolor="#FFFFFF">
					<form:label path="categoria" class="encabezadoCampos">Categoria:</form:label><br/>
					<form:select path="categoria" class="anchoCampos" >
						<option value="Planta Externa Mantenimiento">Planta Externa Mantenimiento</option>
						<option value="Planta Interna">Planta Interna</option>
						<option value="Planta Externa">Planta Externa</option>
						<option value="Planta Externa Construcción">Planta Externa Construcción</option>
						<option value="Planta Externa Fusión">Planta Externa Fusión</option>
						<option value="Planta Externa Radio Frecuencia">Planta Externa Radio Frecuencia</option>
					</form:select>
    			</td>
				<td bgcolor="#FFFFFF">
				<form:label type="text" path="grupo" class="encabezadoCampos">Grupo:</form:label><br/>
					<form:select path="grupo" class="anchoCampos" >
						<option value="Herramienta Especializada">Herramienta Especializada</option>
						<option value="Herramienta Básica">Herramienta Básica</option>
						<option value="Equipo de Proteccion Personal">Equipo de Proteccion Personal</option>
						<option value="Equipo de Demarcación de Trabajos en la Calle">Equipo de Demarcación de Trabajos en la Calle</option>
					</form:select>
					</td>
			</tr>
			</table>
...
<thead  class="letrath">
  ...
  <tr  class="letra">
    ...
    <td align="center">${listValue.categoria}</td>
    <td align="center">${listValue.grupo}</td>
  </tr>
	</c:forEach>
</table>
